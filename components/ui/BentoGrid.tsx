...
export const BentoGridItem = ({
  ...
  const leftLists = ["Typescript", "AI/ML", "Data Science"];
  const rightLists = ["Servers", "Maths", "Python"];
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            titleClassName,
            id !== 5 && "group-hover/bento:translate-x-2",
        ...
        >
          ...
          <div className="font-sans font-extralight md:max-w-62 md:text-lg lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
            ...
            <div className="flex items-center md:gap-3 gap-6">
              {socialMedia?.map((info: any) => (
                <a
                  ...
                  className="w-40 h-20 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300"
                >
